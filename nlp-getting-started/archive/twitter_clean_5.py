...
def clean_slang(text):
    ...
    text=re.sub(r'\bUS((\-)|(\s))(\d{1,}) SB\b', r'United States \4 South Bound',text)
    text=re.sub(r'\bUS((\-)|(\s))(\d{1,}) NB\b', r'United States \4 North Bound',text)
    text=re.sub(r'\bRt (\d{1,}) NB\b', r'Route North Bound \1',text)
    return text
